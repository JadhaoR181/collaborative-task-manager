...
export default function TaskList() {
  ...
  if (showOverdue) return task.isOverdue;
  return true;
});
  ...
  const stats = {
    ...
    overDue: filteredTasks?.filter((t) => t.isOverdue).length || 0
  };
            ...
            <div className="relative">
              <select
                onChange={(e) => {
                  ...
                  setStatus(value === "OVERDUE" ? undefined : value);
                  setShowOverdue(value === "OVERDUE");
                }}
